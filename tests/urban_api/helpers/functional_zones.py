...
async def functional_zone_type(client) -> dict[str, Any]:
    ...
    response = await client.post("/api/v1/functional_zones_types", json=functional_zone_type_post_req.model_dump())
...
@pytest_asyncio.fixture(scope="function")
async def profiles_reclamation_data(client, functional_zone_type) -> dict[str, Any]:
    ...
    response = await client.put("/api/v1/profiles_reclamation", json=profiles_reclamation_post_req.model_dump())
...
@pytest_asyncio.fixture(scope="function")
async def functional_zone(client, functional_zone_type, city) -> dict[str, Any]:
    ...
    response = await client.post("/api/v1/functional_zones", json=functional_zone_post_req.model_dump())
...
@pytest_asyncio.fixture(scope="function")
async def scenario_functional_zone(client, functional_zone_type, scenario, superuser_token) -> dict[str, Any]:
