"""Integration tests for territory-related services are defined here."""
...
async def test_get_service_types_by_territory_id(
    ...
    """Test GET /territory/{territory_id}/service_types method."""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (400, "Пожалуйста, выберите либо service_type_id, либо urban_function_id", None, "v2"),
...
async def test_get_services_by_territory_id(
    ...
    """Test GET /territory/{territory_id}/services method."""

    # Arrange
    territory_id = territory_id_param or object_geometry["territory"]["id"]
    params = {
        "service_type_id": service["service_type"]["service_type_id"],
        "name": service["name"],
...
async def test_get_services_with_geometry_by_territory_id(
    ...
    """Test GET /territory/{territory_id}/services_with_geometry method."""
    ...
    if response.status_code == 200:
        ...
        try:
            ServiceWithGeometry(**result["results"][0])
        except ValidationError as e:
            pytest.fail(f"Pydantic validation error: {str(e)}")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (400, "Пожалуйста, выберите либо service_type_id, либо urban_function_id", None, 2),
...
async def test_get_services_geojson_by_territory_id(
    ...
    """Test GET /territory/{territory_id}/services_geojson method."""
