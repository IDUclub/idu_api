...
async def test_get_physical_object_types_by_territory_id(
    ...
    # Act
    response = await client.get(f"/api/v1/territory/{territory_id}/physical_object_types", params=params)
...
async def test_get_physical_objects_by_territory_id(
    ...
    # Act
    response = await client.get(f"/api/{version}/territory/{territory_id}/physical_objects", params=params)
...
async def test_get_physical_objects_with_geometry_by_territory_id(
    ...
    response = await client.get(
        f"/api/{version}/territory/{territory_id}/physical_objects_with_geometry", params=params
    )
    result = response.json()
...
async def test_get_physical_objects_geojson_by_territory_id(
    ...
    # Act
    response = await client.get(f"/api/v1/territory/{territory_id}/physical_objects_geojson", params=params)
    result = response.json()
