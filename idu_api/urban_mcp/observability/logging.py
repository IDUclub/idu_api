...
from idu_api.urban_api.observability.config import LoggingConfig
...
def configure_logging(
    ...
    root_logger.setLevel(level_name_mapping[config.root_logger_level])
    ...
    logger: structlog.stdlib.BoundLogger = structlog.get_logger("urban_mcp")
