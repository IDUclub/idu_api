...
async def get_physical_objects_by_scenario_id_from_db(  # pylint: disable=too-many-locals
    conn: AsyncConnection,
    scenario_id: int,
    user: UserDTO | None,
...
async def get_physical_objects_with_geometry_by_scenario_id_from_db(  # pylint: disable=too-many-locals
    conn: AsyncConnection,
    scenario_id: int,
    user: UserDTO | None,
    physical_object_type_id: int | None,
...
async def get_physical_objects_around_geometry_by_scenario_id_from_db(  # pylint: disable=too-many-locals
    conn: AsyncConnection,
    scenario_id: int,
    user: UserDTO | None,
    geometry: Geom,
...
async def get_context_physical_objects_from_db(  # pylint: disable=too-many-locals
    conn: AsyncConnection,
    scenario_id: int,
    user: UserDTO | None,
    physical_object_type_id: int | None,
...
async def get_context_physical_objects_with_geometry_from_db(  # pylint: disable=too-many-locals
    conn: AsyncConnection,
    scenario_id: int,
    user: UserDTO | None,
    physical_object_type_id: int | None,
    ...
    regional_scenario_geoms_query = scenario_geoms_query.where(projects_urban_objects_data.c.scenario_id == parent_id)

    queries = [public_urban_objects_query, regional_scenario_geoms_query]

    if include_scenario_objects:
        project_scenario_geoms_query = scenario_geoms_query.where(
            projects_urban_objects_data.c.scenario_id == scenario_id,
        )
        queries.append(project_scenario_geoms_query)
        ...
        queries.append(scenario_objects_with_public_geoms_query)
