...
from idu_api.urban_api.schemas import CursorPage, PhysicalObject, PhysicalObjectWithGeometry
...
async def get_physical_objects_with_geometry_by_territory_id(
    ...
    **WARNING 2:** You can only filter by physical object type or physical object function.
    ...
    ### Returns:
    - **CursorPage[PhysicalObjectWithGeometry]**: A paginated list of physical objects,
